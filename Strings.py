...
print(f"'{letter}' appears {word.count(letter)} times(s) in '{word}'")

substring = input("Enter a substring:")
print(f"'{substring} appears {word.count(substring)} times(s) in '{word}'")
...
char_to_replace = input("Enter a second word: ")
...
print("Is a plaindrome?", is_palindrome)
